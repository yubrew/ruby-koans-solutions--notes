...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # libraries and Object#send could both be used. When doing Object#send,
    # we can instead use __send__ to enhance readability.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # It would no longer throw the NoMethodError, and would just follow 
    # the new behavior. This is seen in the explanation below about Ruby 1.9
    #
    # NOTE:
    #
