...
class AboutSymbols < EdgeCase::Koan
  ...
  #
  # because identical symbols are the same internal object, so comparing identical symbols is 
  # not as robust as comparing strings.
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      puts all_symbols.include?(RubyConstant)
  ...
  #
  # Symbols can't be manipulated easily like strings.
end
