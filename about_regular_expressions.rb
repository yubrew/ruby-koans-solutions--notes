...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # If there was something added after the asterisk, so it would nil out. [/z*f/]
  end
  ...
  # Why?
  #
  # The or more means they take as much repetition as they can get, hence "greedy"
  ...
  # ------------------------------------------------------------------
  # character class matches(or complements) specific character groups. alternations match OR patterns
